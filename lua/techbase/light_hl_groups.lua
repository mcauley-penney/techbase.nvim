...
return function(c)
  ...
  hl["MatchParen"] = { fg = c.operator, bg = c.normal_embed_bg }
  ...
  hl["Search"] = { fg = c.normal_fg, bg = c.search }
  hl["SignColumn"] = { fg = "fg" }
  ...
  hl["StatusLineNC"] = {}
  hl["Substitute"] = { fg = c.cursor, bg = c.normal_embed_bg }
